    ...
    <main>
        ...
        <section class="pedido">
            ...
            <div class="box_pedido">
                <img src="./imagens/fogao.jpg" id="item">
                <h2>Fogão de Piso 4 Bocas Cinza Brastemp</h2>
                <p>Descrição: Clean BFO4NAR - Bivolt</p>
                <p>Valor: R$ 1099.00</p>
                <br><br>
            </div>
            ...
            <div class="box_formulario">
                <form method="post" action="">
                    ...
                    <p>Informe a cor que deseja:
                        <input type="radio" name="produto" value="fogao1">
                        <label for="fogao1">Branca</label>
                        <input type="radio" name="produto" value="fogao1">
                        <label for="fogao1">Preta</label><br><br></p>
