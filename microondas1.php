    ...
    <main>
        ...
        <section class="pedido">
            ...
            <div class="box_pedido">
                <img src="./imagens/microondas2.png" id="item">
                <h2>Micro-ondas Philco</h2>
                <p>Descrição: 30 Litros PME31</p>
                <p>Valor: R$ 429.00</p>
                <br><br>
            </div>
            ...
            <div class="box_formulario">
                <form method="post" action="">
                    ...
                    <p>Informe a cor que deseja:
                        <input type="radio" name="produto" value="microondas1">
                        <label for="microondas1">Branca</label>
                        <input type="radio" name="produto" value="microondas1">
                        <label for="microondas1">Preta</label><br><br></p>
