    ...
    <main>
        ...
        <section class="pedido">
            ...
            <div class="box_pedido">
                <img src="./imagens/geladeira.png" id="item">
                <h2>Geladeira Frost Free Brastemp</h2>
                <p>Descrição: Side Iverse 540 litros</p>
                <p>Valor: R$ 5019.00</p>
                <br><br>
            </div>
            ...
            <div class="box_formulario">
                <form method="post" action="">
                    ...
                    <p>Informe a cor que deseja:
                        <input type="radio" name="produto" value="geladeira1">
                        <label for="geladeira1">Branca</label>
                        <input type="radio" name="produto" value="geladeira1">
                        <label for="geladeira1">Preta</label><br><br></p>
