    ...
    <main>
        ...
        <section class="pedido">
            ...
            <div class="box_pedido">
                ...
                <h2>Fogão 5 Bocas Supreme Timer Glass Dako</h2>
                <p>Descrição: Bivolt</p>
                <p>Valor: R$ 1299.90</p>
                <br><br>
            </div>
            ...
            <div class="box_formulario">
                <form method="post" action="">
                    ...
                    <p>Informe a cor que deseja:
                        <input type="radio" name="produto" value="fogao3">
                        <label for="fogao3">Branca</label>
                        <input type="radio" name="produto" value="fogao3">
                        <label for="fogao3">Preta</label><br><br></p>
