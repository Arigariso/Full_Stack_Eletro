    ...
    <main>
        ...
        <section class="pedido">
            ...
            <div class="box_pedido">
                <img src="./imagens/maquina2.png" id="item">
                <h2>Máquina de Lavar Brastemp</h2>
                <p>Descrição: 12Kg titânio com Ciclo Tira Manchas Advanced e Ciclo Antibolinha • 110V</p>
                <p>Valor: R$ 2200.50</p>
                <br><br>
            </div>
            ...
            <div class="box_formulario">
                <form method="post" action="">
                    ...
                    <p>Informe a cor que deseja:
                        <input type="radio" name="produto" value="maquina2">
                        <label for="maquina2">Branca</label>
                        <input type="radio" name="produto" value="maquina2">
                        <label for="maquina2">Preta</label><br><br></p>
