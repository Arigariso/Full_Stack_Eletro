    ...
    <main>
        ...
        <section class="pedido">
            ...
            <div class="box_pedido">
                <img src="./imagens/geladeira2.jpg" id="item">
                <h2>Geladeira Consul Frost Free Duplex</h2>
                <p>Descrição: 405 litros cor Inox com Filtro Bem Estar</p>
                <p>Valor: R$ 5750.00</p>
                <br><br>
            </div>
            ...
            <div class="box_formulario">
                <form method="post" action="">
                    ...
                    <p>Informe a cor que deseja:
                        <input type="radio" name="produto" value="geladeira2">
                        <label for="geladeira2">Branca</label>
                        <input type="radio" name="produto" value="geladeira2">
                        <label for="geladeira2">Preta</label><br><br></p>
