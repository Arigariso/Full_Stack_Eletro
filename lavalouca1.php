    ...
    <main>
        ...
        <section class="pedido">
            ...
            <div class="box_pedido">
                <img src="./imagens/lavalouca.jpg" id="item">
                <h2>Lava-Louças de Piso Brastemp</h2>
                <p>Descrição: BLF08AS 5 Programas Inox - 220V</p>
                <p>Valor: R$ 2089.00</p>
                <br><br>
            </div>
            ...
            <div class="box_formulario">
                <form method="post" action="">
                    ...
                    <p>Informe a cor que deseja:
                        <input type="radio" name="produto" value="lavalouca1">
                        <label for="lavalouca">Branca</label>
                        <input type="radio" name="produto" value="lavalouca">
                        <label for="lavalouca">Preta</label><br><br></p>
