    ...
    <main>
        ...
        <section class="pedido">
            ...
            <div class="box_pedido">
                <img src="./imagens/maquina.png" id="item">
                <h2>Máquina de Lavar Consul 14Kg</h2>
                <p>Descrição: branca com Dosagem Extra Econômica e Ciclo Edredom</p>
                <p>Valor: R$ 2850.00</p>
                <br><br>
            </div>
            ...
            <div class="box_formulario">
                <form method="post" action="">
                    ...
                    <p>Informe a cor que deseja:
                        <input type="radio" name="produto" value="maquina1">
                        <label for="maquina1">Branca</label>
                        <input type="radio" name="produto" value="maquina1">
                        <label for="maquina1">Preta</label><br><br></p>
