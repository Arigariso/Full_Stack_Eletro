    ...
    <main>
        ...
        <section class="pedido">
            ...
            <div class="box_pedido">
                <img src="./imagens/foga%203.jpg" id="item">
                <h2>Micro-ondas Electrolux</h2>
                <p>Descrição: MTD30 20 Litros Branco 110V</p>
                <p>Valor: R$ 599.00</p>
                <br><br>
            </div>
            ...
            <div class="box_formulario">
                <form method="post" action="">
                    ...
                    <p>Informe a cor que deseja:
                        <input type="radio" name="produto" value="microondas2">
                        <label for="microondas2">Branca</label>
                        <input type="radio" name="produto" value="microondas2">
                        <label for="microondas2">Preta</label><br><br></p>
