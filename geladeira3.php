    ...
    <main>
        ...
        <section class="pedido">
            ...
            <div class="box_pedido">
                <img src="./imagens/geladeira3.jpg" id="item">
                <h2>Geladeira Brastemp</h2>
                <p>Descrição: Retrô Frost Free</p>
                <p>Valor: R$ 2564.05</p>
                <br><br>
            </div>
            ...
            <div class="box_formulario">
                <form method="post" action="">
                    ...
                    <p>Informe a cor que deseja:
                        <input type="radio" name="produto" value="geladeira3">
                        <label for="geladeira3">Branca</label>
                        <input type="radio" name="produto" value="geladeira2">
                        <label for="geladeira3">Preta</label><br><br></p>
