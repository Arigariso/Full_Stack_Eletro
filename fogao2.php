    ...
    <main>
        ...
        <section class="pedido">
            ...
            <div class="box_pedido">
                <img src="./imagens/fogao2.webp" id="item">
                <h2>Fogão Atlas 4 Bocas Tropical Glass</h2>
                <p>Descrição: Acendimento Automático – Preto</p>
                <p>Valor: R$ 719.00</p>
                <br><br>
            </div>
            ...
            <div class="box_formulario">
                <form method="post" action="">
                    ...
                    <p>Informe a cor que deseja:
                        <input type="radio" name="produto" value="fogao2">
                        <label for="fogao2">Branca</label>
                        <input type="radio" name="produto" value="fogao2">
                        <label for="fogao2">Preta</label><br><br></p>
